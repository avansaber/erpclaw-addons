#!/usr/bin/env python3
"""ERPClaw-Ops v2 — Unified router for 126 actions across 6 domains.
...
# Action → domain mapping (120 unique actions + 6 status aliases)
# Only collision: `status` in all 6 domains → routes to manufacturing.
ACTION_MAP = {
    ...
    # === Advanced Manufacturing (34 actions, excl. status alias) ===
    # Shop Floor (8)
    "add-shop-floor-entry": "erpclaw-advmfg",
    "update-shop-floor-entry": "erpclaw-advmfg",
    "get-shop-floor-entry": "erpclaw-advmfg",
    "list-shop-floor-entries": "erpclaw-advmfg",
    "complete-shop-floor-entry": "erpclaw-advmfg",
    "shop-floor-dashboard": "erpclaw-advmfg",
    "production-log-report": "erpclaw-advmfg",
    "oee-report": "erpclaw-advmfg",
    # Tools (8)
    "add-tool": "erpclaw-advmfg",
    "update-tool": "erpclaw-advmfg",
    "get-tool": "erpclaw-advmfg",
    "list-tools": "erpclaw-advmfg",
    "add-tool-usage": "erpclaw-advmfg",
    "list-tool-usage": "erpclaw-advmfg",
    "calibration-due-report": "erpclaw-advmfg",
    "tool-utilization-report": "erpclaw-advmfg",
    # ECO (8)
    "add-eco": "erpclaw-advmfg",
    "update-eco": "erpclaw-advmfg",
    "get-eco": "erpclaw-advmfg",
    "list-ecos": "erpclaw-advmfg",
    "submit-eco-for-review": "erpclaw-advmfg",
    "approve-eco": "erpclaw-advmfg",
    "implement-eco": "erpclaw-advmfg",
    "reject-eco": "erpclaw-advmfg",
    # Recipes (10, excl. status)
    "add-recipe": "erpclaw-advmfg",
    "update-recipe": "erpclaw-advmfg",
    "get-recipe": "erpclaw-advmfg",
    "list-recipes": "erpclaw-advmfg",
    "add-recipe-ingredient": "erpclaw-advmfg",
    "update-recipe-ingredient": "erpclaw-advmfg",
    "list-recipe-ingredients": "erpclaw-advmfg",
    "remove-recipe-ingredient": "erpclaw-advmfg",
    "clone-recipe": "erpclaw-advmfg",
    "calculate-recipe-cost": "erpclaw-advmfg",
}
...
ALIASES = {
    ...
    "advmfg-status": ("erpclaw-advmfg", "status"),
}
