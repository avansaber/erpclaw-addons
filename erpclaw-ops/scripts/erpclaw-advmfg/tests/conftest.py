"""Shared pytest fixtures for ERPClaw Advanced Manufacturing unit tests."""
import os
import sys
...
import pytest
from advmfg_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with foundation + advmfg schema."""
...
@pytest.fixture
def env(conn):
    """Full advmfg environment: company, naming series."""
