"""Shared pytest fixtures for ERPClaw Quality unit tests."""
import os
import sys
...
import pytest
from quality_helpers import init_all_tables, get_conn, build_env
...
@pytest.fixture
def env(conn):
    """Full quality environment: company, naming series, item."""
