"""Shared pytest fixtures for ERPClaw Support unit tests."""
import os
import sys
...
import pytest
from support_helpers import init_all_tables, get_conn, build_env
...
@pytest.fixture
def env(conn):
    """Full support environment: company, naming series, customer, item."""
