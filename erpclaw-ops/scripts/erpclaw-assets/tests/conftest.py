"""Shared pytest fixtures for ERPClaw Assets unit tests."""
import os
import sys
...
import pytest
from assets_helpers import init_all_tables, get_conn, build_env
...
@pytest.fixture
def env(conn):
    """Full assets environment: company, naming series, category, asset."""
