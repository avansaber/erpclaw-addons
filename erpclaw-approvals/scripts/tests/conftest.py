"""Shared pytest fixtures for ERPClaw Approvals unit tests."""
import os
import sys
...
import pytest
from approvals_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with foundation + approvals schema."""
...
@pytest.fixture
def env(conn):
    """Full approvals environment: company, naming series."""
