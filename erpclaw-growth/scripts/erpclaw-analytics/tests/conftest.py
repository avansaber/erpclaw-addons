"""Shared pytest fixtures for ERPClaw Analytics unit tests."""
import os
import sys
...
import pytest
from analytics_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with foundation + growth schema."""
...
@pytest.fixture
def env(conn):
    """Full analytics environment: company, accounts, GL entries."""
