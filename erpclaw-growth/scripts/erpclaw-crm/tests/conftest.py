"""Shared pytest fixtures for ERPClaw CRM unit tests."""
import os
import sys
...
import pytest
from crm_helpers import init_all_tables, get_conn, build_env
...
@pytest.fixture
def env(conn):
    """Full CRM environment: company, naming series, customer."""
