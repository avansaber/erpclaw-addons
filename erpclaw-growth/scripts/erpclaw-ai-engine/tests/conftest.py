"""Shared pytest fixtures for ERPClaw AI Engine unit tests."""
import os
import sys
...
import pytest
from ai_helpers import init_all_tables, get_conn, build_env
...
@pytest.fixture
def env(conn):
    """Full AI engine environment: company, accounts, GL entries."""
