"""Shared pytest fixtures for ERPClaw CRM-ADV unit tests."""
import os
import sys
...
import pytest
from crm_adv_helpers import init_all_tables, get_conn, build_env
...
@pytest.fixture
def env(conn):
    """Full CRM-ADV environment: company, naming series."""
