...
# Import gl_invariants from foundation's shared lib.
# After the 2026-05-04 split, gl_invariant_checker.py moved out of the
# erpclaw-os/ subdir and its public surface lives at
