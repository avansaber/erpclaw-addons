"""Shared pytest fixtures for ERPClaw Self-Service unit tests."""
import os
import sys
...
import pytest
from selfservice_helpers import init_all_tables, get_conn, build_env, load_db_query


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with full ERPClaw core + selfservice schema."""
...
@pytest.fixture
def env(conn):
    """Full selfservice environment: company, profile, user_id, naming series."""
