"""Shared pytest fixtures for ERPClaw Maintenance unit tests."""
import os
import sys
...
import pytest
from maintenance_helpers import init_all_tables, get_conn, build_env, load_db_query


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with full ERPClaw core + maintenance schema."""
...
@pytest.fixture
def env(conn):
    """Full maintenance environment: company, naming series."""
