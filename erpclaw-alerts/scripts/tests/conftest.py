"""Shared pytest fixtures for ERPClaw Alerts unit tests."""
import os
import sys
...
import pytest
from alerts_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with foundation + alerts schema."""
...
@pytest.fixture
def env(conn):
    """Full alerts environment: company, naming series."""
