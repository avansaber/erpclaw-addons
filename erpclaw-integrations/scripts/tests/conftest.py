"""Shared pytest fixtures for ERPClaw Integrations unit tests."""
import os
import sys
...
import pytest
from integration_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with foundation + integrations schema."""
...
@pytest.fixture
def env(conn):
    """Full integrations environment: company, naming series, connector."""
