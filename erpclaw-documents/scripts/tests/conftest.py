"""Shared pytest fixtures for ERPClaw Documents unit tests."""
import os
import sys
...
import pytest
from documents_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with foundation + documents schema."""
...
@pytest.fixture
def env(conn):
    """Full documents environment: company, naming series, document, template."""
