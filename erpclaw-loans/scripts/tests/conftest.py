"""Shared pytest fixtures for ERPClaw Loans unit tests."""
import os
import sys
...
import pytest
from loans_helpers import init_all_tables, get_conn, build_env, load_db_query


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with full ERPClaw core + loans schema."""
...
@pytest.fixture
def env(conn):
    """Full loans environment: company, customer, employee, supplier, accounts, naming series."""
