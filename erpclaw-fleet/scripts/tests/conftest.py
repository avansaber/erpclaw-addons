"""Shared pytest fixtures for ERPClaw Fleet unit tests."""
import os
import sys
...
import pytest
from fleet_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with foundation + fleet schema."""
...
@pytest.fixture
def env(conn):
    """Full fleet environment: company, naming series, vehicle."""
